  ...
  static ThemeData get dark {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: TextStyle(color: AppColorTheme.dark.textSecondary),
        hintStyle: TextStyle(color: AppColorTheme.dark.textHint),
  ...
  static ThemeData get light {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: TextStyle(color: AppColorTheme.light.textSecondary),
        hintStyle: TextStyle(color: AppColorTheme.light.textHint),
